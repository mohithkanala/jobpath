...
/**
 * update-system.mjs — Safe auto-updater for jobpath
 *
...
const CANONICAL_REPO = 'https://github.com/mohithkanala/jobpath.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/mohithkanala/jobpath/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/mohithkanala/jobpath/releases/latest';
    ...
    [versionResult, releaseResult] = await Promise.allSettled([
      ...
      fetch(RELEASES_API, {
        headers: {
          ...
          'User-Agent': 'jobpath-update-checker',
        },
