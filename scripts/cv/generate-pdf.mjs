 ...
 *
 * Usage:
 *   node jobpath/generate-pdf.mjs <input.html> <output.pdf> [--format=letter|a4]
 *
...
// Ensure jobs directory exists (fresh setup)
mkdirSync(resolve(PROJECT_ROOT, 'jobs'), { recursive: true });
...
async function generatePDF() {
  ...
  // Resolve font paths relative to jobpath/fonts/
