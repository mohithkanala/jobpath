...
jobpath supports Codex through the root `AGENTS.md` file.
...
- `Evaluate this job URL with jobpath and run the full pipeline.`
- `Scan my configured portals for new roles that match my profile.`
- `Generate the tailored ATS PDF for this role using jobpath.`
...
jobpath modes and scripts rather than introducing a parallel automation
layer.
