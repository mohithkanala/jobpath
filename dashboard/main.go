...
import (
	...
	"github.com/mohithkanala/jobpath/dashboard/internal/data"
	"github.com/mohithkanala/jobpath/dashboard/internal/model"
	"github.com/mohithkanala/jobpath/dashboard/internal/theme"
	"github.com/mohithkanala/jobpath/dashboard/internal/ui/screens"
)
...
func main() {
	pathFlag := flag.String("path", ".", "Path to jobpath directory")
	flag.Parse()
