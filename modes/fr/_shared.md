# Contexte partage -- jobpath (Francais)

<!-- ============================================================
     PERSONNALISATION DE CE FICHIER
     ============================================================
     Ce fichier contient le contexte partage pour tous les modes
     jobpath en version francaise. Avant d'utiliser jobpath, tu DOIS :
...
1b. **Premiere evaluation de chaque session :** Lancer `node scripts/pipeline/cv-sync-check.mjs` via Bash. En cas d'alertes, prevenir le candidat
...
9. **Entrees tracker en TSV** -- NE JAMAIS editer applications.md directement pour de nouveaux ajouts. Ecrire le TSV dans `batch/tracker-additions/`, `scripts/tracker/merge-tracker.mjs` gere la fusion
