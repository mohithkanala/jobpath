# Geteilter Kontext -- jobpath (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle jobpath-Modi
     in der deutschen Variante. Bevor du jobpath verwendest, MUSST du:
...
1b. **Bei der ersten Bewertung jeder Session:** `node scripts/pipeline/cv-sync-check.mjs` per Bash ausführen. Bei Warnungen den Kandidaten informieren, bevor weitergearbeitet wird
...
9. **Tracker-Einträge als TSV** — `applications.md` NIEMALS direkt für neue Einträge editieren. TSV in `batch/tracker-additions/` schreiben, `scripts/tracker/merge-tracker.mjs` übernimmt das Mergen
