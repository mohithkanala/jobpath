...
12. Write to `jobs/cv-{candidate}-{company}-{YYYY-MM-DD}.tex`
13. Run: `node scripts/cv/generate-latex.mjs jobs/cv-{candidate}-{company}-{YYYY-MM-DD}.tex jobs/cv-{candidate}-{company}-{YYYY-MM-DD}.pdf`
